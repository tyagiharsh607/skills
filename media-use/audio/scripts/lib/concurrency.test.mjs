...
// Regression: audio.mjs used a bare Promise.all(lines.map(ingestLine)) to
// transcribe every TTS line at once, spawning one Whisper model load per line
// concurrently. Two independent reports of this overwhelming a machine (OOM,
// and cold-start contention causing spurious failures).
